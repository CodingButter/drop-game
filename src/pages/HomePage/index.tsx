        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-6">
              ...
              <Link to="/chat" className="text-text-secondary hover:text-text transition-colors">
                Chat
              </Link>
              <Link to="/games" className="text-text-secondary hover:text-text transition-colors">
                Games
              </Link>
            </div>
          </div>
