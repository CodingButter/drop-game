...
import { IRCClientProvider } from "./providers/IRCClientProvider"
  ...
  <StrictMode>
    <IRCClientProvider
      ...
      onClientCreated={(client) => {
        console.log("IRC client created and ready")
        // Store a reference globally for debugging
        ;(window as any).ircClient = client

        // Attach basic debug handlers
        attachDebugHandlers(client)
      }}
    >
      <App />
    </IRCClientProvider>
